				...
				<div className="space-y-5">
					...
					{r.admissionChances && (
						<section className="rounded-2xl border border-border bg-card p-5">
							...
							{/* Admission band disclaimer */}
							<div className="mt-3 flex items-start gap-2 rounded-lg border border-[#C49A3C]/30 bg-[#C49A3C]/[0.07] px-3 py-2.5">
								<Info className="mt-0.5 size-3.5 shrink-0 text-[#C49A3C]" />
								<p className="text-xs text-[#C49A3C]/90 leading-relaxed">
									<strong>AI estimate only.</strong> Admission chance bands are generated by AI based on your profile and are not based on historical admit data. They are indicative only — individual decisions depend on many factors including essay quality, interview performance, and cohort composition. Do not use this to determine whether to apply to a program.
								</p>
							</div>
						</section>
					)}
