			...
			{!result ? (
				...
				<FadeIn>
					<div className="space-y-6">
						...
						<div className="rounded-lg border border-[#C0392B]/25 bg-[#C0392B]/[0.06] px-4 py-3 space-y-1.5">
							<p className="text-xs font-semibold text-[#C0392B]">⚠ Immigration rules change — verify before acting</p>
							<p className="text-xs text-[#C0392B]/90 leading-relaxed">
								Visa policies, processing times, point thresholds, and PR routes change frequently. This guide is generated by AI based on publicly available information and <strong>may not reflect the latest policy changes</strong>. Always verify current requirements on the official government source linked in each country section before making any application or financial decisions.
							</p>
							<p className="text-xs text-[#C49A3C]">{result.disclaimer}</p>
						</div>
					</div>
				</FadeIn>
			)}
